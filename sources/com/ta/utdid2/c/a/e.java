...
class e {
    ...
    public static final HashMap m67a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m68a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
    ...
    private static final Object b(XmlPullParser xmlPullParser, String[] strArr) throws XmlPullParserException, IOException {
        ...
        if (!name.equals("null")) {
            if (name.equals("string")) {
                ...
                xmlPullParser.next();
                int[] m68a = m68a(xmlPullParser, "int-array", strArr);
                strArr[0] = attributeValue;
                return m68a;
            } else if (name.equals("map")) {
                xmlPullParser.next();
                HashMap m67a = m67a(xmlPullParser, "map", strArr);
                strArr[0] = attributeValue;
                return m67a;

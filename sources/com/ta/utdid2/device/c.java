...
public class c {
    ...
    private com.ta.utdid2.c.a.c f151a;
    ...
    /* renamed from: a  reason: collision with other field name */
    private Pattern f153a = Pattern.compile("[^0-9a-zA-Z=/+]+");
    ...
    public c(Context context) {
        ...
        this.f151a = new com.ta.utdid2.c.a.c(context, ".DataStorage", "ContextData", false, true);
        this.f152a = new d();
    ...
    private void d() {
        ...
        if (cVar != null) {
            if (i.m61a(cVar.getString("UTDID2"))) {
            ...
            boolean z = false;
            if (!i.m61a(this.b.getString("DID"))) {
                this.b.remove("DID");
                z = true;
            }
            if (!i.m61a(this.b.getString("EI"))) {
                this.b.remove("EI");
                z = true;
            }
            if (!i.m61a(this.b.getString("SI"))) {
                this.b.remove("SI");
                z = true;
            }
            if (z) {
    ...
    private void g(String str) {
        com.ta.utdid2.c.a.c cVar;
        if (str != null && (cVar = this.f151a) != null && !str.equals(cVar.getString(this.m))) {
            this.f151a.putString(this.m, str);
            this.f151a.commit();
        }
    }
    ...
    private String g() {
        ...
        if (cVar != null) {
            ...
            if (!i.m61a(string) && this.f152a.a(string) != null) {
                return string;
            }
            return null;
        }
    ...
    private boolean b(String str) {
        if (str != null) {
            ...
            if (24 == str.length() && !this.f153a.matcher(str).find()) {
                return true;
            }
        }
        return false;
    ...
    public synchronized String h() {
        ...
        String string2 = this.f151a.getString(this.m);
        if (!i.m61a(string2)) {
            String b3 = eVar.b(string2);
            if (!b(b3)) {
                b3 = this.f152a.b(string2);
            }
            if (b(b3)) {
                String a4 = this.f152a.a(b3);
                if (!i.m61a(b3)) {
                    this.l = b3;
                    if (z) {
                        j(a4);
